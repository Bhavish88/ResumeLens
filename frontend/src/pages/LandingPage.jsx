      ...
      <nav className="landing-nav">
        <div className="landing-nav-inner">
          <Link to="/" className="landing-nav-logo">
            ...
            <span className="landing-nav-brand-text">ResumeLens</span>
          </Link>
          ...
          <div className="landing-nav-actions">
            <button className="landing-theme-toggle" onClick={toggleTheme} title={`Switch to ${theme === 'dark' ? 'light' : 'dark'} mode`}>
              {theme === 'dark' ? (
        ...
        {menuOpen && (
          <div className="mobile-menu mobile-menu--open">
            ...
            <button className="mobile-menu-link mobile-theme-btn" onClick={() => { toggleTheme(); setMenuOpen(false); }}>
